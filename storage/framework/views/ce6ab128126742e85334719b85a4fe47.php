        ...
        <div class="d-flex row col-4 flex-nowrap justify-content-end">
            ...
            <div class="btn-group" style="width: auto;">
                ...
                <ul class="dropdown-menu" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 38px);" data-popper-placement="bottom-start">
                    <?php if(\App\Models\Admin::checkAccess('record','store',"deliveries")): ?>
                        <li>
                            <a  href="<?php echo e(route('record.storeform',['slug'=>'deliveries'])); ?>"  type="button" class="dropdown-item btn ">
                    ...
                    <?php endif; ?>
                    <li>
                        <a href="<?php echo e(route('record.export',['slug'=>'deliveries'])); ?>"  type="button" class="dropdown-item btn ">
                    ...
                    <li>
                        <a href="<?php echo e(route('record.pdf',['slug'=>'deliveries'])); ?>"  type="button" class="dropdown-item btn ">
        ...
        <div class="row">
            <div class="card" id="table-box" >
                ...
                <div class="card-datatable table-responsive">
                    <table id="ajax_table" class="table table-bordered " sortLink="<?php echo e(route('record.sort',['slug'=>'deliveries'])); ?>">
                        <thead>
                        <tr>
                            <th>#</th>

                            <th><?php echo e(__("عکس سرویس")); ?></th>
                            <th><?php echo e(__("نام سرویس")); ?></th>
                            <th><?php echo e(__("قیمت پایه")); ?></th>
                            <th><?php echo e(__("ضریب قیمت")); ?></th>
                            <th><?php echo e(__("درصد قیمت عجله دارم")); ?></th>
                            <th><?php echo e(__("تصویر صفحه انتظار")); ?></th>
                            <th><?php echo e(__("عنوان صفحه انتظار")); ?></th>
                            <th><?php echo e(__("توضیح صفحه انتظار")); ?></th>
                            <th><?php echo e(__("نسبة العودة")); ?></th>
                            <th><?php echo e(__("نوع سرویس")); ?></th>
                            <th><?php echo e(__("درصد کاهش قیمت سرویس اقتصادی")); ?></th>
                            <th><?php echo e(__("آیکن سرویس اقتصادی")); ?></th>
                            <th><?php echo e(__("تكلفة الدقيقة (دینار)")); ?></th>
                            <th><?php echo e(__("سرویس مرتبط")); ?></th>
                            <th><?php echo e(__("نمایش در صفحه اصلی")); ?></th>
                            <th><?php echo e(__("دارای سرویس اقتصادی")); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        $('#ajax_table').DataTable({
            "ajax":"<?php echo e(route('record.pagination',['slug'=>'deliveries'])); ?>",
            "columns":[
            ...
            "processing": true,
            "serverSide": true,
            <?php if($tableInfo!=null && $tableInfo->slug=="deliveries" && $tableInfo->parentSlug==null && $tableInfo->parentId==null): ?>
...
<?php echo $__env->make('admin-panel.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qozeem/projects/web/wasalney/resources/views/admin-panel/my-deliveries/index.blade.php ENDPATH**/ ?>