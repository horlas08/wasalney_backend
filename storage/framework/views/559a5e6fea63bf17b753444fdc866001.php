...
<div class="sidebar-main-box close-side" >
    <div class="nav flex-column nav-pills DC_menu-bar" id="menu-bar" role="tablist" aria-orientation="vertical" >
        ...
        <div class="DC_items">
            ...
            <?php if(\App\Models\Admin::checkAccess('airline-travel','show')): ?>
                <a id="v-airline-travel-tab" href="<?php echo e(route('admin.airline-travel.index')); ?>" class="nav-link DC_item_tabBox DC_link_item">
                    <i class="fa-solid fa-plane-departure"></i>
                    <span class="DC_tooltip_text"><?php echo e(__('Airline Travel')); ?></span>
                </a>
            <?php endif; ?>
...
<?php /**PATH /home/qozeem/projects/web/wasalney/resources/views/admin-panel/layout/sidebar.blade.php ENDPATH**/ ?>