<?php $__env->startSection('content'); ?>
    ...
    <?php echo e(__("توليد الأكواد مستخدم")); ?>
        ...
        <div class="d-flex row col-4 flex-nowrap justify-content-end">
            ...
            <div class="btn-group" style="width: auto;">
                ...
                <ul class="dropdown-menu" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 38px);" data-popper-placement="bottom-start">
                    <?php if(\App\Models\Admin::checkAccess('record','store',"generate_code")): ?>
                        <li>
                            <a  href="<?php echo e(route('record.storeform',['slug'=>'generate_code'])); ?>"  type="button" class="dropdown-item btn ">
                    ...
                    <?php endif; ?>
                    <li>
                        <a href="<?php echo e(route('record.export',['slug'=>'generate_code'])); ?>"  type="button" class="dropdown-item btn ">
                    ...
                    <li>
                        <a href="<?php echo e(route('record.pdf',['slug'=>'generate_code'])); ?>"  type="button" class="dropdown-item btn ">
        ...
        <div class="row">
            <div class="card" id="table-box" >
                ...
                <div class="card-datatable table-responsive">
                    <table id="ajax_table" class="table table-bordered " sortLink="<?php echo e(route('record.sort',['slug'=>'generate_code'])); ?>">
                        <thead>
                        <tr>
                            <th>#</th>

                            <th><?php echo e(__("تعداد")); ?></th>
                            <th><?php echo e(__("ارزش (دینار)")); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        $('#ajax_table').DataTable({
            "ajax":"<?php echo e(route('record.pagination',['slug'=>'generate_code'])); ?>",
            "columns":[
            ...
            "processing": true,
            "serverSide": true,
            <?php if($tableInfo!=null && $tableInfo->slug=="generate_code" && $tableInfo->parentSlug==null && $tableInfo->parentId==null): ?>
        ...
        <?php ($lastCategory=\App\Models\Category::where("slug",'generate_code')->first()); ?>
...
<?php echo $__env->make('admin-panel.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qozeem/projects/web/wasalney/laravel/resources/views/admin-panel/my-generate_code/index.blade.php ENDPATH**/ ?>