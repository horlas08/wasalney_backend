<?php $__env->startSection('content'); ?>
    ...
    <?php ($parent=$parentSlug!=null?db($parentSlug)->find($parentId):null); ?>
        ...
        <h4 class="py-3 breadcrumb-wrapper  col-4 ">
            <?php while($preSlug!=null): ?>
                <?php ($lastCategory=\App\Models\Category::where('slug',$preSlug)->first()); ?>
                <a href="<?php echo e(route('record.index',['slug'=>$preSlug,'parentSlug'=>$preParent->parent_slug,'parentId'=>$preParent->parent_id])); ?>" class=" fw-light"><?php echo e(__($lastCategory->title)); ?> /</a>
        ...
        <div class="d-flex row col-4 flex-nowrap justify-content-end">
            ...
            <a href="<?php echo e($parent!=null?route('record.index',['slug'=>$parentSlug,'parentSlug'=>$parent->parent_slug,'parentId'=>$parent->parent_id]):route('admin.dashboard')); ?>" type="button" class="btn btn-outline-primary " style="width: auto!important;">
            ...
            <div class="btn-group" style="width: auto;">
                ...
                <ul class="dropdown-menu" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 38px);" data-popper-placement="bottom-start">
                    <?php if(\App\Models\Admin::checkAccess('record','store',"message")): ?>
                        <li>
                            <a  href="<?php echo e(route('record.storeform',['slug'=>'message','parentSlug'=>$parentSlug,'parentId'=>$parentId])); ?>"  type="button" class="dropdown-item btn ">
                    ...
                    <?php endif; ?>
                    <li>
                        <a href="<?php echo e(route('record.export',['slug'=>'message','parentSlug'=>$parentSlug,'parentId'=>$parentId])); ?>"  type="button" class="dropdown-item btn ">
                    ...
                    <li>
                        <a href="<?php echo e(route('record.pdf',['slug'=>'message','parentSlug'=>$parentSlug,'parentId'=>$parentId])); ?>"  type="button" class="dropdown-item btn ">
        ...
        <div class="row">
            <div class="card" id="table-box" >
                ...
                <div class="card-datatable table-responsive">
                    <table id="ajax_table" class="table table-bordered " sortLink="<?php echo e(route('record.sort',['slug'=>'message'])); ?>">
                        <thead>
                        <tr>
                            <th>#</th>

                            <th><?php echo e(__("راننده")); ?></th>
                            <th><?php echo e(__("کاربر")); ?></th>
                            <th><?php echo e(__("پیام")); ?></th>
                            <th><?php echo e(__("ارسال کننده کاربر")); ?></th>
                            <th><?php echo e(__("ارسال کننده راننده")); ?></th>
                            <th><?php echo e(__("تاریخ ایجاد")); ?></th>
                            <th><?php echo e(__("تاریخ ویرایش")); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        $('#ajax_table').DataTable({
            "ajax":"<?php echo e(route('record.pagination',['slug'=>'message','parentSlug'=>$parentSlug,'parentId'=>$parentId])); ?>",
            "columns":[
            ...
            "processing": true,
            "serverSide": true,
            <?php if($tableInfo!=null && $tableInfo->slug=="message" && $tableInfo->parentSlug==$parentSlug && $tableInfo->parentId==$parentId): ?>
        ...
        <?php ($lastCategory=isset($lastCategory)?$lastCategory:(\App\Models\Category::where("slug",'message')->first())); ?>
...
<?php echo $__env->make('admin-panel.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qozeem/projects/web/wasalney/resources/views/admin-panel/my-message/index.blade.php ENDPATH**/ ?>