...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'generate_code','id'=>$generate_code->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("توليد الأكواد مستخدم")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'generate_code'])}}" class="btn btn-outline-primary me-3">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="count" type="number" name="count" value="{{$generate_code->count}}" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="price">{{__("ارزش (دینار)")}}</label>
                                        <input id="price" type="number" name="price" value="{{$generate_code->price}}" class="form-control"  />
                                        </div>
