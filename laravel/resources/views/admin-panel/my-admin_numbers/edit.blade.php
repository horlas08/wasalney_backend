...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'admin_numbers','id'=>$admin_numbers->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("شماره داخلی ادمین ها")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'admin_numbers'])}}" class="btn btn-outline-primary me-3">
