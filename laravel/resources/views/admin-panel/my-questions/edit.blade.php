...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'questions','id'=>$questions->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("سوالات متداول")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'questions'])}}" class="btn btn-outline-primary me-3">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                        <label class="form-label" for="question">{{__("سوال")}}</label>
                                        <input id="question" type="text" name="question" value="{{$questions->question}}" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="answer">{{__("پاسخ")}}</label>
                                        <input id="answer" type="text" name="answer" value="{{$questions->answer}}" class="form-control"  />
                                        </div>
