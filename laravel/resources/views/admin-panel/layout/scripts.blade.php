...
<script src={{asset("admin-panel/plugins/bootstrap/bootstrap.min.js")}}></script>

<!-- Main Scripts -->
<script src={{asset("admin-panel/scripts/main.js")}}></script>

<script>
    @if(App\Models\Visit::where('ip','!=',null)->whereYear('date','<', \Carbon\Carbon::now()->year)->exists())
