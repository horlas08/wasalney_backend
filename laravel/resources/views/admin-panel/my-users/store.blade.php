...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'users'])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("کاربران")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div style="display: flex" deleteUrl="{{route('file.delete',['slug'=>'users','fieldName'=>'image'])}}">
                                        </div>
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="birth_date">{{__("تاریخ تولد")}}</label>
                                        @if(getLang()=='fa')
                                        <input data-jdp name="birth_date"  type="text" id="birth_date" class="form-control" value="">
                                        @else
