...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'repetitive_place','parentSlug'=>$parentSlug,'parentId'=>$parentId])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("مسیر پر تکرار")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <option  value="{{$favorite_place->id}}">{{"$favorite_place->title"}}</option>
                                        @endforeach
                                        </select>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <input id="title_origin" type="text" name="title_origin" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="lat_origin">{{__("lat مبدا")}}</label>
                                        <input id="lat_origin" type="text" name="lat_origin" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="long_origin">{{__("long مبدا")}}</label>
                                        <input id="long_origin" type="text" name="long_origin" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="lat_destination">{{__("lat مقصد")}}</label>
                                        <input id="lat_destination" type="text" name="lat_destination" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="long_destination">{{__("long مقصد")}}</label>
                                        <input id="long_destination" type="text" name="long_destination" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="title_destination">{{__("عنوان مقصد")}}</label>
                                        <input id="title_destination" type="text" name="title_destination" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="address_origin">{{__("آدرس مبدا")}}</label>
                                        <input id="address_origin" type="text" name="address_origin" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="address_destination">{{__("آدرس مقصد")}}</label>
                                        <input id="address_destination" type="text" name="address_destination" value="" class="form-control"  />
                                        </div>
