...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'favorite_place'])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("مکان های منتخب")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="plack" type="text" name="plack" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
