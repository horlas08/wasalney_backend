...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'floor_detail'])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("جزئیات طبقات")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                        <input type="hidden" name="elevator" value="1">
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="place">{{__("محل")}}</label>
                                        <input id="place" type="text" name="place" value="" class="form-control"  />
                                        </div>
