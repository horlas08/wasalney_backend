...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'documents','parentSlug'=>$parentSlug,'parentId'=>$parentId])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("مدارک راننده")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div style="display: flex" deleteUrl="{{route('file.delete',['slug'=>'documents','fieldName'=>'on_car_card'])}}">
                                        </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div style="display: flex" deleteUrl="{{route('file.delete',['slug'=>'documents','fieldName'=>'back_car_card'])}}">
                                        </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div style="display: flex" deleteUrl="{{route('file.delete',['slug'=>'documents','fieldName'=>'on_certificate'])}}">
                                        </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div style="display: flex" deleteUrl="{{route('file.delete',['slug'=>'documents','fieldName'=>'additional_documents'])}}">
                                        </div>
                                        </div>
