...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'stop_without_driver','parentSlug'=>$parentSlug,'parentId'=>$parentId])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("آیتم توقف بدون راننده")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="time" type="text" name="time" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="minutes">{{__("زمان بر اساس دقیقه")}}</label>
                                        <input id="minutes" type="number" name="minutes" value="" class="form-control"  />
                                        </div>
