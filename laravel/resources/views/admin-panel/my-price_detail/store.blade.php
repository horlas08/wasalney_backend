...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'price_detail','parentSlug'=>$parentSlug,'parentId'=>$parentId])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("جزئیات قیمت")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="multiply_price" type="number" name="multiply_price" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="hurry_percent">{{__("درصد قیمت عجله دارم")}}</label>
                                        <input id="hurry_percent" type="number" name="hurry_percent" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <input id="final_price" type="number" name="final_price" value="" class="form-control"  />
                                        </div>
