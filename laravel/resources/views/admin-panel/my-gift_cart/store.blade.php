...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'gift_cart'])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("تخفیف")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="gift_code" type="text" name="gift_code" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="percent">{{__("درصد تخفیف")}}</label>
                                        <input id="percent" type="number" name="percent" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="expire_date">{{__("تاریخ اعتبار")}}</label>
                                        @if(getLang()=='fa')
                                        <input data-jdp name="expire_date"  type="text" id="expire_date" class="form-control" value="">
                                        @else
                                        <input id="expire_date" type="date" name="expire_date" class="form-control" value=""/>
                                        @endif
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <input id="min_price" type="number" name="min_price" value="" class="form-control"  />
                                        </div>
