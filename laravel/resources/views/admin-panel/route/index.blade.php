...
@section('content')
    ...
    <div class="d-flex row justify-content-between align-items-center col-12 mb-3">
        ...
        <div class="d-flex row col-4 flex-nowrap justify-content-end">
            ...
            <a href="{{route('route.storeform')}}" class="" tabindex="0" aria-controls="DataTables_Table_0" type="button" style="width: auto!important;">
                    ...
                    <table class="dt-responsive table table-bordered " >
                        ...
                        @foreach(\App\Models\Route::all() as $route)
                            ...
                            <td></td>
                                ...
                                <td>{{$route->title}}</td>
                                <td>
                                    <a href="{{url('/'.$route->address)}}" target="_blank">
                                        {{url('/'.$route->address)}}
                                    </a>
                                </td>
                                <td>{{$route->view}}</td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="">
                                                <li><a class="dropdown-item"
                                                       href="{{route('route.editform',['id'=>$route->id])}}">
                                                        <i class="bx bx-edit-alt me-1"></i> {{__('Edit')}}</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item text-danger" data-bs-toggle="modal"
                                                       data-bs-target="#basicModal"
                                                       onclick="setModalRoute('{{route('route.destroy',['id'=>$route->id])}}')">
