...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'gender','id'=>$gender->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("جنسیت")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'gender'])}}" class="btn btn-outline-primary me-3">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="title" type="text" name="title" value="{{$gender->title}}" class="form-control"  />
                                        </div>
