...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'taxi_options','id'=>$taxi_options->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("آپشن های سواری")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'taxi_options','parentSlug'=>$parentSlug,'parentId'=>$parentId])}}" class="btn btn-outline-primary me-3">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                        <label class="form-label" for="helper">{{__("مقدار افزایش قیمت برای همیار (ريال)")}}</label>
                                        <input id="helper" type="number" name="helper" value="{{$taxi_options->helper}}" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="cooler">{{__("درصد افزایش قیمت برای کولر")}}</label>
                                        <input id="cooler" type="number" name="cooler" value="{{$taxi_options->cooler}}" class="form-control"  />
                                        </div>
