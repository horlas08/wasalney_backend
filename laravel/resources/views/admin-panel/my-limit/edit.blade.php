...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'limit','id'=>$limit->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("محدوده")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'limit'])}}" class="btn btn-outline-primary me-3">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                        <label class="form-label" for="meter">{{__("متر")}}</label>
                                        <input id="meter" type="number" name="meter" value="{{$limit->meter}}" class="form-control"  />
                                        </div>
