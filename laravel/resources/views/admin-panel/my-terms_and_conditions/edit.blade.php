...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'terms_and_conditions','id'=>$terms_and_conditions->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("قوانین و مقررات")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'terms_and_conditions'])}}" class="btn btn-outline-primary me-3">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                        <label class="form-label" for="text">{{__("متن")}}</label>
                                        <textarea style="display: none" id="text" name="text" >{!! $terms_and_conditions->text !!}</textarea>
                                        <div class="ck-editor" id="editor-text" textarea_id="text">{!! $terms_and_conditions->text !!}</div>
                                        </div>
