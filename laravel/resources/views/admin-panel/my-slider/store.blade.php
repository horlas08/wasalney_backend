...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'slider'])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("اسلایدر")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div style="display: flex" deleteUrl="{{route('file.delete',['slug'=>'slider','fieldName'=>'image'])}}">
                                        </div>
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="link">{{__("لینک")}}</label>
                                        <input id="link" type="url" name="link" value="" class="form-control"  style="direction:ltr !important;"/>
                                        </div>
