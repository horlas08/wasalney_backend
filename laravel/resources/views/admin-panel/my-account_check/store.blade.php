...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'account_check'])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("التحقق من حسابات السائقين")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="card_number" type="text" name="card_number" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <option  value="{{$state_driver->id}}">{{"$state_driver->title"}}</option>
                                        @endforeach
                                        </select>
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="shaba">{{__("شماره شبا کارت")}}</label>
                                        <input id="shaba" type="number" name="shaba" value="" class="form-control"  />
                                        </div>
