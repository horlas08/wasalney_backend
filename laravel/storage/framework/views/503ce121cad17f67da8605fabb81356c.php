<?php $__env->startSection('content'); ?>
    ...
    <?php echo e(__("سرویس مسیر های پرتکرار")); ?>
        ...
        <div class="d-flex row col-4 flex-nowrap justify-content-end">
            ...
            <div class="btn-group" style="width: auto;">
                ...
                <ul class="dropdown-menu" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 38px);" data-popper-placement="bottom-start">
                    <?php if(\App\Models\Admin::checkAccess('record','store',"service_place_repitive")): ?>
                        <li>
                            <a  href="<?php echo e(route('record.storeform',['slug'=>'service_place_repitive'])); ?>"  type="button" class="dropdown-item btn ">
                    ...
                    <?php endif; ?>
                    <li>
                        <a href="<?php echo e(route('record.export',['slug'=>'service_place_repitive'])); ?>"  type="button" class="dropdown-item btn ">
                    ...
                    <li>
                        <a href="<?php echo e(route('record.pdf',['slug'=>'service_place_repitive'])); ?>"  type="button" class="dropdown-item btn ">
        ...
        <div class="row">
            <div class="card" id="table-box" >
                ...
                <div class="card-datatable table-responsive">
                    <table id="ajax_table" class="table table-bordered " sortLink="<?php echo e(route('record.sort',['slug'=>'service_place_repitive'])); ?>">
                        <thead>
                        <tr>
                            <th>#</th>

                            <th><?php echo e(__("سرویس")); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        $('#ajax_table').DataTable({
            "ajax":"<?php echo e(route('record.pagination',['slug'=>'service_place_repitive'])); ?>",
            "columns":[
            ...
            "processing": true,
            "serverSide": true,
            <?php if($tableInfo!=null && $tableInfo->slug=="service_place_repitive" && $tableInfo->parentSlug==null && $tableInfo->parentId==null): ?>
        ...
        <?php ($lastCategory=\App\Models\Category::where("slug",'service_place_repitive')->first()); ?>
...
<?php echo $__env->make('admin-panel.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qozeem/projects/web/wasalney/laravel/resources/views/admin-panel/my-service_place_repitive/index.blade.php ENDPATH**/ ?>