<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex row justify-content-between align-items-center col-12 mb-3">
        ...
        <div class="d-flex row col-4 flex-nowrap justify-content-end">
            ...
            <a href="<?php echo e(route('language.storeform')); ?>" class="" tabindex="0" aria-controls="DataTables_Table_0" type="button" style="width: auto!important;">
                ...
                <div class="card-datatable table-responsive">
                    <table class="dt-responsive table table-bordered " >
                        ...
                        <tr>
                            ...
                            <th><?php echo e(__('Abbreviation')); ?></th>
                            ...
                            <td></td>
                                ...
                                <td>
                                    <div class="form-check form-check-inline">
                                        <input name="is_default" onclick="onCheckbox(this,'<?php echo e(route('language.default',['id'=>$language->id])); ?>')"
                                             class="form-check-input" type="radio"  id="customCheck<?php echo e($language->id); ?>" <?php echo e($language->is_default==1?'checked':''); ?>>
                                        <label class="form-check-label" for="customCheck<?php echo e($language->id); ?>"></label>
                                    </div>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="">
                                                <li><a class="dropdown-item"
                                                       href="<?php echo e(route('language.editform',['id'=>$language->id])); ?>">
                                                        <i class="bx bx-edit-alt me-1"></i> <?php echo e(__('Edit')); ?></a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item text-danger" data-bs-toggle="modal"
                                                       data-bs-target="#basicModal"
                                                       onclick="setModalRoute('<?php echo e(route('language.destroy',['id'=>$language->id])); ?>')">
...
<?php echo $__env->make('admin-panel.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qozeem/projects/web/wasalney/laravel/resources/views/admin-panel/language/index.blade.php ENDPATH**/ ?>