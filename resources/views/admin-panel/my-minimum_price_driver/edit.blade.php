...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'minimum_price_driver','id'=>$minimum_price_driver->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("حد الاقصى لديون السائق")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'minimum_price_driver'])}}" class="btn btn-outline-primary me-3">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                        <label class="form-label" for="price">{{__("المبلغ( دينار)")}}</label>
                                        <input id="price" type="number" name="price" value="{{$minimum_price_driver->price}}" class="form-control"  />
                                        </div>
