...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'car_details','id'=>$car_details->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("مشخصات ماشین")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="color" type="text" name="color" value="{{$car_details->color}}" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="car_tag">{{__("پلاک")}}</label>
                                        <input id="car_tag" type="text" name="car_tag" value="{{$car_details->car_tag}}" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <option {{$car_details->fuel_type==$fuel_type->id?"selected":""}} value="{{$fuel_type->id}}">{{"$fuel_type->title"}}</option>
                                        @endforeach
                                        </select>
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="vin">{{__("شماره شناسه خودرو")}}</label>
                                        <input id="vin" type="text" name="vin" value="{{$car_details->vin}}" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="year_made">{{__("سال ساخت")}}</label>
                                        <input id="year_made" type="text" name="year_made" value="{{$car_details->year_made}}" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="model">{{__("مدل ماشین")}}</label>
                                        <input id="model" type="text" name="model" value="{{$car_details->model}}" class="form-control"  />
                                        </div>
