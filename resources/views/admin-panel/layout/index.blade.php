...
{{--    <title>Panel</title>--}}
    @include('seo.meta',['title'=>__('Admin Panel')])
    @include('admin-panel.layout.styles')
    @yield('styles')
</head>
...
<body class="index-box {{$selectedLang==null || $selectedLang->direction=='rtl'?'dir_right':'dir_left'}}">
...
<div class="notify-box" id="notifications">
    ...
    <div class="notify-item">
        <img src={{asset("admin-panel/images/notify-light.png")}} alt="">
        <strong>عنوان نوتفیکیشن</strong>
        <span>23 خرداد 1401</span>
        <a href="#">مشاهده</a>
    </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="fp-gallery" role="tabpanel" aria-labelledby="fp-gallery-tab" tabindex="0">
                        <div class="files-grid">
                            <div class="file-item fi-image"><img src={{asset("admin-panel/images/gallery/01.jpg")}} alt=""><span>Filename-01.jpg</span></div>
                            <div class="file-item fi-video"><span>Filename-01.jpg</span></div>
                            <div class="file-item fi-image"><img src={{asset("admin-panel/images/gallery/02.jpg")}} alt=""><span>Filename-01.jpg</span></div>
                            <div class="file-item fi-audio"><span>Filename-01.jpg</span></div>
                            <div class="file-item fi-archive"><span>Filename-01.jpg</span></div>
                            <div class="file-item fi-image"><img src={{asset("admin-panel/images/gallery/03.jpg")}} alt=""><span>Filename-01.jpg</span></div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title secondary-font" id="exampleModalLabel1">{{__('Final Confirmation')}}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                {{__('Are you sure about the operation?')}}
            </div>
            <div class="modal-footer">
                <button id="btn_close_modal" type="button" class="btn btn-label-secondary" data-bs-dismiss="modal">
                    {{__('No')}}
                </button>
                <a id="btn-confirm-modal" href="" type="button" class="btn btn-danger">{{__('Yes')}}</a>
            </div>
        </div>
    </div>
</div>
<!-- Modal -->
@include('admin-panel.layout.scripts')
