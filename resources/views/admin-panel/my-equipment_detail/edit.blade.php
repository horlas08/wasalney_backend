...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'equipment_detail','id'=>$equipment_detail->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("جزئیات وسایل")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'equipment_detail','parentSlug'=>$parentSlug,'parentId'=>$parentId])}}" class="btn btn-outline-primary me-3">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="price" type="number" name="price" value="{{$equipment_detail->price}}" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="name">{{__("نام وسیله")}}</label>
                                        <input id="name" type="text" name="name" value="{{$equipment_detail->name}}" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="count">{{__("تعداد")}}</label>
                                        <input id="count" type="number" name="count" value="{{$equipment_detail->count}}" class="form-control"  />
                                        </div>
