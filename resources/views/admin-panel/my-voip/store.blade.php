...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'voip'])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("تنظیمات voip")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="ip" type="text" name="ip" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="user_name">{{__("نام کاربری")}}</label>
                                        <input id="user_name" type="text" name="user_name" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="pass">{{__("رمز")}}</label>
                                        <input id="pass" type="text" name="pass" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="trank">{{__("نام ترانک")}}</label>
                                        <input id="trank" type="text" name="trank" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="gateway">{{__("پیش شماره گیت وی")}}</label>
                                        <input id="gateway" type="text" name="gateway" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="pre_trank">{{__("پیش شماره ترانک")}}</label>
                                        <input id="pre_trank" type="text" name="pre_trank" value="" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="port">{{__("پورت")}}</label>
                                        <input id="port" type="text" name="port" value="" class="form-control"  />
                                        </div>
