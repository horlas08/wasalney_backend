...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'driver_agency','id'=>$driver_agency->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("تعیین راننده آژانس")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'driver_agency'])}}" class="btn btn-outline-primary me-3">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="mobile" type="text" name="mobile" value="{{$driver_agency->mobile}}" class="form-control"  />
                                        </div>
                                        <div class="col-md-12">
                                        <label class="form-label" for="verify_code">{{__("کد تایید")}}</label>
                                        <input id="verify_code" type="text" name="verify_code" value="{{$driver_agency->verify_code}}" class="form-control"  />
                                        </div>
