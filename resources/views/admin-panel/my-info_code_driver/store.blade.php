...
@section('content')
    ...
    <form action="{{route('record.store',['slug'=>'info_code_driver','parentSlug'=>$parentSlug,'parentId'=>$parentId])}}"
                ...
                <div class="card" >
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Store') }} {{__("معلومات رمز الرصید السائق")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <option  value="{{$drivers->id}}">{{"$drivers->name $drivers->mobile"}}</option>
                                        @endforeach
                                        </select>
                                        </div>
