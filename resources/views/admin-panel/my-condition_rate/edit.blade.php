...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'condition_rate','id'=>$condition_rate->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("نرخ امتیاز بر اساس مبلغ سفارش")}}</h5>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <input id="price" type="number" name="price" value="{{$condition_rate->price}}" class="form-control"  />
                                        </div>
