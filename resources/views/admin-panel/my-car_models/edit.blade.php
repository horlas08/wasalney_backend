...
@section('content')
    ...
    <form action="{{route('record.update',['slug'=>'car_models','id'=>$car_models->id])}}"
                ...
                <div class="card" id="form-box">
                    ...
                    <div id="sticky-wrapper" class="sticky-wrapper" >
                        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                            <h5 class="card-title mb-sm-0 me-2">{{ __('Edit') }} {{__("مدل های ماشین")}}</h5>
                            <div class="action-btns ">
                                <a href="{{route('record.index',['slug'=>'car_models'])}}" class="btn btn-outline-primary me-3">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                        <label class="form-label" for="title">{{__("اسم")}}</label>
                                        <input id="title" type="text" name="title" value="{{$car_models->title}}" class="form-control"  />
                                        </div>
