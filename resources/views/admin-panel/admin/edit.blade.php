...
@section('content')
    ...
    <form action="{{route('admin.update',['id'=>$admin->id])}}"
                    ...
                    <div class="card" >
                        ...
                        <div id="sticky-wrapper" class="sticky-wrapper" >
                            <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
                                <h5 class="card-title mb-sm-0 me-2">{{__('Edit Admin')}}</h5>
                                ...
                                <div class="col-lg-11 mx-auto">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" id="number" name="number" class="form-control" value="{{$admin->number}}" />
                                        </div>
